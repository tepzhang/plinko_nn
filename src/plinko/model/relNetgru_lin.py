...
class relNetgru(nn.Module):
    ...
    def __init__(self,
        ...
        hsize = num_gaussians + num_gaussians * 2 + num_gaussians * 3
        self.output_size = [num_gaussians, num_gaussians * 2, num_gaussians * 3]
        self.final_layer = nn.Linear(gru_out_size+rel_out_size *(obj_n+nullobj_n),
                                     sum(self.output_size))
...
class relNetgru_det(nn.Module):
    ...
    def __init__(self,
                 ...
                 rel_hn = 2, rel_out_size = 8,
                 mlp_hn = 2):
        super(relNetgru_det, self).__init__()
        ...
        # final aggregator MLP
        self.mlp_hn = mlp_hn
        self.final_layer_det = nn.Linear(gru_out_size+rel_out_size *(obj_n+nullobj_n),
                                     self.state_size)
